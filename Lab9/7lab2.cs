...
class Program2
{
    static void Main2(string[] args)
    {
        ...
        MySerializeJson<List<Diver>>.Serialize(divers, "Results/divers.json");

        MySerializeXml<List<Diver>>.Serialize(divers, "Results/divers.xml");

        MySerializeBinary<List<Diver>>.Serialize(divers, "Results/divers.bin");
