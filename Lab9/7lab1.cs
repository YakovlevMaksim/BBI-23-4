...
class Program
{
    static void Main(string[] args)
    {
        ...
        jsonSerializer.Serialize(jumpers, "Results/jumpers.json");

        MySerializeBinary<List<Jumper>> binarySerializer = new MySerializeBinary<List<Jumper>>();
        binarySerializer.Serialize(jumpers, "Results/jumpers.bin");

        MySerializeXml<List<Jumper>> serializer = new MySerializeXml<List<Jumper>>();
        serializer.Serialize(jumpers, "Results/jumpers.xml");
